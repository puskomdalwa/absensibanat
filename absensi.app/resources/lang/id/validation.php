...
return [
    ...
    | ukuran. Silakan sesuaikan pesan ini sesuai dengan kebutuhan aplikasi Anda.
    |
    */
    ...
    | konvensi "attribute.rule" untuk menamai baris ini. Ini memungkinkan Anda
    | dengan cepat menentukan pesan bahasa khusus untuk aturan atribut tertentu.
    |
    */
