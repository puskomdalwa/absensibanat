...
<div class="offcanvas offcanvas-end" id="new-record">
    ...
    <div class="offcanvas-body flex-grow-1">
        <form class="record pt-0 row g-2" id="form-new-record" action="{{ route('admin.absensi.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#new-record-button', function() {
                ...
                $('#form-new-record [name="user_id"]').focus();
            });
